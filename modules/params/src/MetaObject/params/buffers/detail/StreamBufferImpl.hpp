...
namespace Buffer {
    ...
    template <class T>
    boost::optional<size_t> StreamBuffer<T>::getFrameBufferCapacity() { return _frame_padding; }

    template <class T>
    OptionalTime_t StreamBuffer<T>::getTimePaddingCapacity() { return _time_padding; }
