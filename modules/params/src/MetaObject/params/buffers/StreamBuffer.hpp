...
namespace Buffer {
    ...
    public:
        ...
        typedef void(TUpdateSig_t)(ConstStorageRef_t, IParam*, const ContextPtr_t&, OptionalTime_t, size_t, const std::shared_ptr<ICoordinateSystem>&, UpdateFlags);
    ...
    protected:
        bool updateDataImpl(const T& data, const OptionalTime_t& ts, const ContextPtr_t& ctx, size_t fn, const std::shared_ptr<ICoordinateSystem>& cs);
