    ...
    namespace python
    {
        ...
        namespace detail
        {
            ...
            void addPropertyHelper(BP& bpobj, mo::_counter_<0>)
            {
                ...
                bpobj.add_property(mo::reflect::getName<0, T>(), static_cast<Return_t(*)(const T&)>(&mo::reflect::getValue<0, T>));
            }
            ...
            void addPropertyHelper(BP& bpobj, mo::_counter_<I>)
            {
                ...
                bpobj.add_property(mo::reflect::getName<I, T>(), static_cast<Return_t(*)(const T&)>(&mo::reflect::getValue<I, T>));
            ...
            template<class T>
            mo::reflect::enable_if_reflected<T> pythonizeDataHelper(const char* name_ = nullptr, const std::vector<T>* = nullptr)
            {
            ...
            mo::reflect::enable_if_reflected<T> pythonizeDataHelper(const char* name = nullptr, const std::map<K, T>* = nullptr)
            {
