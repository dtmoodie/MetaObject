    ...
    namespace python
    {
        ...
        struct LibGuard
        {
            ...
            LibGuard()
            {
                ...
                {
                    using Pool_t = mo::LockPolicy<mo::UsagePolicy<mo::PoolPolicy<cuda::HOST>>>;
                ...
                {
                    using Pool_t = mo::LockPolicy<UsagePolicy<mo::PoolPolicy<cuda::CUDA>>>;
                    using Stack_t = mo::LockPolicy<UsagePolicy<mo::StackPolicy<cuda::CUDA>>>;
                    using Allocator_t = mo::CombinedPolicy<Pool_t, Stack_t>;
