    ...
    */
    class MO_EXPORTS IMetaObject : public IObject
    {
      public:
        ...
        virtual TSlot<
            void(IParam*, Context*, OptionalTime_t, size_t, const std::shared_ptr<ICoordinateSystem>&, UpdateFlags)>*
        getSlot_param_updated() const = 0;
        ...
        virtual std::vector<InputParam*> getInputs(const TypeInfo& type_filter,
      ...
      protected:
        ...
        virtual void onParamUpdate(
            IParam*, Context*, OptionalTime_t, size_t, const std::shared_ptr<ICoordinateSystem>&, UpdateFlags) = 0;
    };
    ...
    class MO_EXPORTS MetaObject : public IMetaObject
    {
      public:
        ...
        getSlot_param_updated() const override;
