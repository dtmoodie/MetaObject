...
namespace mo
{
    ...
    MetaObject::MetaObject()
    {
        ...
        _pimpl->_slot_param_updated = std::bind(&MetaObject::onParamUpdate, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5, std::placeholders::_6);
    }
    ...
    bool MetaObject::connectInput(InputParam* input,
        IMetaObject* output_object,
        IParam* output,
        ParamType type_)
    {
    ...
    TSlot<void(IParam*, Context*, OptionalTime_t, size_t, const std::shared_ptr<ICoordinateSystem>&, UpdateFlags)>* MetaObject::getSlot_param_updated() const{
        return &_pimpl->_slot_param_updated;
    }
    ...
    int MetaObject::connectByName(const std::string& signal_name,
    ...
    void MetaObject::onParamUpdate(IParam* param, Context*, OptionalTime_t, size_t, const std::shared_ptr<ICoordinateSystem>&, UpdateFlags)
    {
