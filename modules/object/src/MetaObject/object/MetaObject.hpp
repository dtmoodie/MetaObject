...
namespace mo
{
    class MO_EXPORTS MetaObject : virtual public IMetaObject
    {
      public:
        ...
        MO_BASE(MetaObject)
        PROPERTY(stream,
                 &MetaObject::getStream,
                 static_cast<void (MetaObject::*)(const IAsyncStreamPtr_t&)>(&MetaObject::setStream))
        MO_END;
        ...
        void setStream(const IAsyncStreamPtr_t& ctx, bool overwrite) override;
