...
namespace mo
{
    ...
    namespace UI
    {
        namespace qt
        {
            ...
            template<> class MO_EXPORTS THandler<Writypedefile, void> : public UiUpdateHandler
            {
                QPushButton* btn;
                QWidget* parent;
                Writypedefile* fileData;
                bool _currently_updating;
            public:
                static const bool IS_DEFAULT = false;
                THandler();
                virtual void UpdateUi( Writypedefile* data);
                virtual void onUiUpdate(QObject* sender);
                virtual void SetData(Writypedefile* data_);
                Writypedefile* GetData();
                virtual std::vector<QWidget*> GetUiWidgets(QWidget* parent_);
            };
