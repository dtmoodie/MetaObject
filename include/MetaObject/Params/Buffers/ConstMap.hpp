...
#define MO_METAParam_INSTANCE_CONST_MAP_(N) \
    ...
    template<class T> ParamConstructor<Buffer::ConstMap<T>> MetaParam<T, N, void>::_map_Param_constructor; \
    template<class T> BufferConstructor<Buffer::ConstMap<T>> MetaParam<T, N, void>::_map_constructor;
