...
static void list_Param_info_(std::vector<mo::ParamInfo*>& info, mo::_counter_<N> dummy) \
{ \
    static mo::ParamInfo s_info(mo::TypeInfo(typeid(type)), #name, "", "", mo::ParamType::Output_e); \
    info.push_back(&s_info); \
    list_Param_info_(info, --dummy); \
} \
SERIALIZE_(name, N)
...
static void list_Param_info_(std::vector<mo::ParamInfo*>& info, mo::_counter_<N> dummy) \
{ \
    static mo::ParamInfo s_info(mo::TypeInfo(typeid(type)), #name, "", "", mo::ParamType::State_e); \
    info.push_back(&s_info); \
    list_Param_info_(info, --dummy); \
} \
SERIALIZE_(name, N)
...
static void list_Param_info_(std::vector<mo::ParamInfo*>& info, mo::_counter_<N> dummy) \
{ \
    static mo::ParamInfo s_info(mo::TypeInfo(typeid(type)), #name, "", "", mo::ParamType::Input_e); \
    info.push_back(&s_info); \
    list_Param_info_(info, --dummy); \
}
